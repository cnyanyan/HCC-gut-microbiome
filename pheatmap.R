...
pheatmap(test, cluster_row = FALSE) pheatmap(test, legend = FALSE)
...
# Specify colors 
ann_colors = list(Time = c("white", "firebrick"), CellType = c(CT1 = "#1B9E77", CT2 = "#D95F02"), 
...
## Not run:
# Same using dendsort package library(dendsort)
library(dendsort)
